...
public class NetworkSavedData extends SavedData {
    ...
    private static NetworkSavedData instance;

    public static void initialize(ServerLevel level) {
        instance = level.getDataStorage().computeIfAbsent(NetworkSavedData::load, NetworkSavedData::new, NAME);
    }
    ...
    public static NetworkSavedData load(CompoundTag tag) {
        ...
        if (instance == null) instance = new NetworkSavedData();
        return instance;
    }
